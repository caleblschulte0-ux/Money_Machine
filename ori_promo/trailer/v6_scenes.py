...
def dakota_a(dur=5.4):
    ...
    render("trailer/seq/v6_dak_a", els, dur, anchor=(1240, 720), t0=0.9,
...
def dakota_b(dur=3.4):
    ...
    render("trailer/seq/v6_dak_b", els, dur, anchor=(1495, 745), t0=0.35,
...
def settle_a(dur=4.0):
    ...
    occ = plate_occluder("raw/IMG_6805.MOV", 27.5,
                        [(1020, 1080), (1030, 800), (1180, 720),
                         ...
                         (1870, 1080)],
                        crop=SETA_CROP)
    render("trailer/seq/v6_set_a", els, dur, anchor=(1300, 880), t0=0.5,
...
def settle_b(dur=3.4):
    ...
    occ = plate_occluder("raw/IMG_6805.MOV", 31.9,
                        ...
                        crop=SETB_CROP)
    render("trailer/seq/v6_set_b", els, dur, anchor=(917, 870), t0=0.35,
...
def ice(dur=9.0):
    ...
    render("trailer/seq/v6_ice", [el], dur, anchor=(585, 400), t0=5.4,
