...
from spec_e2 import BEATS, W, H, FPS, TOTAL

OUT = "out_e2"; RAWD = "../raw"; SR = 48000
...
if __name__ == "__main__":
    ...
    marks()
    import score_e2; score_e2.main()
    import vo_e2; vo_e2.main()
    print("  sound")
    master("../out/ORI_Explainer2_FastFacts_master.mp4"); print("  mastered")
