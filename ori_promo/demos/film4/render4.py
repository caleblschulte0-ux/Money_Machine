...
def draw_label(d, anchor, box_xy, title, sub, k, col=CYAN):
    ...
    # CLAMP. The first b3 render put x0 at -250 and the label read "SURFACE"
    # instead of "BELOW THE SURFACE" -- a caption that lies by being cropped.
