...
import hud as HUD
from spec_e3 import (BEATS, LABELS, ICE, TITLES, UI_OFF, WEARER_BEATS,
...
DIP_TO_BLACK = {"detail", "intro", "hero", "on", "rental", "honest_stage", "off", "reach", "vision"}
...
def main(only=None):
    ...
    # `hero` reads raw/IMG_HERO4.MOV -- the SAME source PNG as v32c's
    # IMG_HERO1.MOV, explain1's IMG_HERO2.MOV and explain2's IMG_HERO3.MOV
    # (ai/hero/glasses_hero_chatgpt.jpg), built at THIS video's own 4.0s
    # duration into its OWN file, so none of the other three is touched.
    # Built once already this session; rebuilt here if a fresh checkout
    # is missing it.
    hero_clip = os.path.join(RAW, "IMG_HERO4.MOV")
