...
from spec_e3 import BEATS, W, H, FPS, TOTAL

OUT = "out_e3"; RAWD = "../raw"; SR = 48000
...
def marks():
    ...
    for b, clip, tin, st, d, note in BEATS:
        ...
        # render_e3.py), so the sound is consistent with the figure-lock
        # sound rather than a new SFX vocabulary. Timed to the reticle's
        # own 0.55s converge window (render_e3.py: `t < 0.55`).
        if b == 'lock':
        ...
        # (hud.boot_pulse()/scan_sweep() in render_e3.py), distinct in
...
if __name__ == "__main__":
    ...
    marks()
    import score_e3; score_e3.main()
    import vo_e3; vo_e3.main()
    print("  sound")
    master("../out/ORI_Explainer3_TheLongTake_master.mp4"); print("  mastered")
