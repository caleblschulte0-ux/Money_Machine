...
import hud as HUD
from spec_e5 import (BEATS, LABELS, ICE, TITLES, UI_OFF, WEARER_BEATS,
...
def main(only=None):
    ...
    # `hero` reads raw/IMG_HERO6.MOV -- the SAME source PNG as v32c's
    # IMG_HERO1.MOV and explain1-4's IMG_HERO2/3/4/5.MOV
    # (ai/hero/glasses_hero_chatgpt.jpg), built at THIS video's own 4.0s
    # pace into its OWN file, so none of the other five is touched.
    # Built once already this session; rebuilt here if a fresh checkout
    # is missing it.
    hero_clip = os.path.join(RAW, "IMG_HERO6.MOV")
