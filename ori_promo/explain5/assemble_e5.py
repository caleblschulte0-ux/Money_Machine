...
from spec_e5 import BEATS, W, H, FPS, TOTAL

OUT = "out_e5"; RAWD = "../raw"; SR = 48000
...
def marks():
    ...
    for b, clip, tin, st, d, note in BEATS:
        ...
        # render_e5.py), so the sound is consistent with the figure-lock
        # sound rather than a new SFX vocabulary. Timed to the reticle's
        # own 0.55s converge window (render_e5.py: `t < 0.55`).
        if b == 'lock':
        ...
        # (hud.boot_pulse()/scan_sweep() in render_e5.py), distinct in
...
if __name__ == "__main__":
    ...
    marks()
    import score_e5; score_e5.main()
    import vo_e5; vo_e5.main()
    print("  sound")
    master("../out/ORI_Explainer5_TheSilentCut_master.mp4"); print("  mastered")
