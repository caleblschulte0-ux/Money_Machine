...
SHOTS = [
    ("open",    f"{RAW_MORE}/IMG_6676.MOV", 11.0, 2.5, dict(stab=True, smooth=90, zoom=6, move=("in", 0.05))),
    ...
    ("reading", f"{RAW}/IMG_6796.MOV",      31.0, 2.5, dict(stab=True, tripod=True, zoom=12, move=("out", 0.04))),
    ...
    ("dakota",  f"{RAW_MORE}/IMG_6804.MOV", 16.5, 2.5, dict(stab=True, tripod=True, zoom=8, fx="dakota", move=("in", 0.04))),
    ...
    ("close",   f"{RAW_MORE}/IMG_6803.MOV",  3.0, 4.0, dict(stab=True, tripod=True, zoom=14, move=("in", 0.05))),
]
