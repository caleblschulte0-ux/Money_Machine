...
Recurring intelligence products for specific industries, built from monitored sources with human review.
...
Phase 7 — needs accumulated operating data to be worth selling.

## Constraints already known

- Source reliability scoring and evidence links are mandatory, not optional.
- Requires a human-review queue before anything reaches a subscriber.
