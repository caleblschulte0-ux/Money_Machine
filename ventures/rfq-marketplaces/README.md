# Request-for-Quote Marketplaces

**Phase:** 9 · **Status:** not started

Focused marketplaces where buyers request quotes from vetted vendors.
...
Phase 9 — the hardest cold-start problem in the portfolio.

## Constraints already known

- Launch only after developing sufficient supply and demand in one narrow category.
