...
The playable branch now uses the reviewed V2 toy-diorama world renderer for
Home, Park, Town, and Beach, including the molded care station and upgraded
world interaction props. Phone-size review snapshots are generated by the
`Barkly world art review` workflow before release review.

## Responsive spacing contract

Interactive chrome uses shared gutters and protected stage clearances rather
