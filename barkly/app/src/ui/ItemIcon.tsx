...
const RENDERED: Record<string, { source: number; aspect: number }> = {
  treat_biscuit: { source: require('../../assets/world/item/treat_biscuit.png'), aspect: 224 / 140 },
  treat_cheese: { source: require('../../assets/world/item/treat_cheese.png'), aspect: 224 / 211 },
  treat_steak: { source: require('../../assets/world/item/treat_steak.png'), aspect: 224 / 150 },
  toy_ball: { source: require('../../assets/world/item/toy_ball.png'), aspect: 224 / 208 },
  toy_rope: { source: require('../../assets/world/item/toy_rope.png'), aspect: 224 / 102 },
  ...
  kit_stick: { source: require('../../assets/world/item/kit_stick.png'), aspect: 224 / 111 },
  home_bed: { source: require('../../assets/world/home/props/bed.png'), aspect: 559 / 188 },
};
