...
// the thing that makes that a requirement rather than a hope.
if (env.EXPO_PUBLIC_BARKLY_HIDE_DEV !== '1') {
  fail('Set EXPO_PUBLIC_BARKLY_HIDE_DEV=1 for a release build so the dev unlock panel is not shipped.');
}
