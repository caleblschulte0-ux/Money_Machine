...
engines = {item.identifier for item in scene.bl_rna.properties["render.engine"].enum_items}
...
# Samples: intentionally game-prop-like instead of shader balls only.
...
# Flatten coin slightly.
bpy.context.object.scale.y = 0.34
bpy.ops.object.transform_apply(location=False, rotation=False, scale=True)

# Dark collar-like foreground strip to show material contrast.
...
# Soft contact shadows / ambient occlusion where supported.
