...
Do not redesign Barkly. This document restates the sheet in words so every
session and every contributor — human or model — can verify work against canon
even without the image open.

> **Concept sheet location:** `app/assets/barkly/concept/barkly-concept.png`
...
Barkly will eventually be a real electronic toy. Favor forms that translate to:
