/**
 * PLACEHOLDER Barkley renderer.
 *
 * This is development stand-in art, not the product. It draws Barkley from
 ...
 *
 * It implements the BarkleyRenderProps contract (src/animation/renderer.ts).
...
import { BarkleyRenderProps } from '../animation/renderer';
import { BodyAction } from '../barkley/types';
...
export default function BarkleyView({ state, actions }: BarkleyRenderProps) {
