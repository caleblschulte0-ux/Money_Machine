 ...
 *
 * This is the slot for Barkley's real, character-consistent voice. It is not
 * implemented yet because it requires (a) an ElevenLabs account + API key and
 * (b) a designed/cloned Barkley voice ID — both product decisions, not code.
 *
 ...
 *  3. Flip the provider choice in registry.ts (env: EXPO_PUBLIC_BARKLEY_TTS).
 *
