...
> Does Barkley feel like a specific little dog you are getting to know,
...
| [`docs/CHARACTER.md`](docs/CHARACTER.md) | Barkley's **locked** character design. Canon. Do not redesign him. |
...
| `app/assets/barkley/` | Character art slot — where the approved concept sheet and future animation assets go (documented in its README). |

## The one rule

Barkley's character design and personality are canon. The concept sheet is the
